...
class LogicUnit
{
    ...
    public:
        ...
        void compare_memory_indirect_8bit(uint8_t register_x, uint16_t address);
        ...
        void logic_or_memory_indirect_8bit(uint8_t register_x, uint16_t address);
        ...
        void logic_and_memory_indirect_8bit(uint8_t register_x, uint16_t address);
        ...
        void logic_xor_memory_indirect_8bit(uint8_t register_x, uint16_t address);
